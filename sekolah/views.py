...
def galeri_detail(request, pk):
    galeri = get_object_or_404(Galeri.objects.prefetch_related('foto_foto'), pk=pk)
    return render(request, 'sekolah/galeri_detail.html', {'galeri': galeri})
